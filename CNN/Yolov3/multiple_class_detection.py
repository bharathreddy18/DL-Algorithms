...
if __name__ == "__main__":
    try:
        multiple = MULTIPLE('images.jpeg')
        final_box, class_ids, confidence_scores, cordinates = multiple.bounding_boxes()
        multiple.predictions(final_box, class_ids, confidence_scores, cordinates)

        cv2.imshow('car and person', multiple.image)
        cv2.waitKey()
